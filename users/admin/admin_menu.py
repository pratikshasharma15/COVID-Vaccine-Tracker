...
from users.admin.admin_controller import vaccines,approve_details,add_user
from users.admin.admin_controller.view_vaccinated_emp import view_vacc_emp_menu as vacc_menu
...
class Admin:
    ...
    def menu(self):
        admin_choice = int(input(PromptsConfig.ADMIN_PROMPT))
